...
async function test() {
  ...
  console.log('Business data identity:', JSON.stringify(businessData.identity, null, 2));
  console.log('Business data location:', JSON.stringify(businessData.location, null, 2));
  console.log('Business data contact:', JSON.stringify(businessData.contact, null, 2));
  
  const brandDNA = await BrandStrategyService.generateBrandDNA(businessData);
  console.log('\nBrand DNA full:', JSON.stringify(brandDNA, null, 2));
}
